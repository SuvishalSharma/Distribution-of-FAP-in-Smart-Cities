...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="attacker.jsp"><span></span></a></li>
        </ul>
      </div>
      <div class="logo">
        <h1><a href="index.html" class="style1">Intelligent Distribution of Fresh Agricultural Products in Smart City</a></h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h1 align="center" class="style2">User PROFILE</h1>
          <p>&nbsp;</p>
...
<table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
        ...
        <%
						...
						String user=(String )request.getParameter("type1");
	  ...
	  <%    
            ...
            <p align="right"><a href="a_blocked_user.jsp" class="style4">Back</a></p>
           <%}
            else if(type.equalsIgnoreCase("two")){%>
            <p align="right"><a href="a_rec_webpages.jsp" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("three")){%>
            <p align="right"><a href="a_wb_viewed.jsp" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("four")){%>
            <p align="right"><a href="a_user_viewed_mal.jsp" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("five")){%>
            <p align="right"><a href="a_mal_viewed.jsp" class="style4">Back</a></p>
			<%}
			else if(type.equalsIgnoreCase("six")){%>
            <p align="right"><a href="a_unblock_user.jsp" class="style4">Back</a></p>
			<%}
