					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="u_register.jsp">Back</a>         <a href="index.html">Home</a> </p>
							<%
					   }
					   else
					   {
					String sta="waiting";
					PreparedStatement ps=connection.prepareStatement("insert into user(name,pass,email,mobile,addr,dob,gender,pin,location,image,status) values(?,?,?,?,?,?,?,?,?,?,?)");
