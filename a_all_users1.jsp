...
<body>
  ...
  <tr>
	...
	<tr>
		<td  valign="baseline" height="0"><p class="style5 style4 style22">&nbsp;</p>
                  <div align="center" class="style22 style4 style5 style10">
                    <%out.println(i);%>
                    <p>&nbsp; </p>
                  </div></td>
              <td width="116" rowspan="1" ><div class="style5 style4 style22" style="margin:10px 13px 10px 13px;" ><strong> <a class="#" id="img1" href="#" >
                  <input  name="image" type="image" src="u_Pic.jsp?id=<%=i%>" style="width:90px; height:90px;" />
              </a> </strong></div></td>
              <td  valign="baseline" height="0"><p class="style5 style4 style22">&nbsp;</p>
                  <div align="center" class="style22 style4 style5 style12">
                    <%out.println(s2);%>
                    <p>&nbsp; </p>
                  </div></td>
              <td  valign="baseline" height="0"><p class="style5 style4 style22">&nbsp;</p>
                  <div align="center" class="style22 style4 style5 style14">
                    <%out.println(s4);%>
                    <p>&nbsp; </p>
                  </div></td>
              <td  valign="baseline" height="0"><p class="style5 style4 style22">&nbsp;</p>
                  <div align="center" class="style22 style4 style5 style16">
                    <%out.println(s5);%>
                    <p>&nbsp; </p>
                  </div></td>
              <td  valign="baseline" height="0"><p class="style5 style4 style22">&nbsp;</p>
                  <div align="center" class="style22 style4 style5 style18">
                    <%out.println(s7);%>
                    <p>&nbsp; </p>
                  </div></td>
			  <td  valign="baseline" height="0"><p class="style5 style4 style22">&nbsp;</p>
                  <div align="center" class="style22 style4 style5 style20">
                    <%out.println(s6);%>
                    <p>&nbsp; </p>
                  </div></td>
			  <td  valign="baseline" height="0"><p class="style5 style4">&nbsp;</p>
                  <div align="center" class="style4 style5 style22">
                    <%out.println(s8);%>
                    <p>&nbsp; </p>
                  </div></td>
			  <td  valign="baseline" height="0"><p class="style5 style4">&nbsp;</p>
                  <div align="center" class="style4 style5 style24">
                    <%out.println(s9);%>
                    <p>&nbsp; </p>
                  </div></td>
			  <td  valign="baseline" height="0"><p class="style5 style4">&nbsp;</p>
                  <div align="center" class="style4 style5 style26">
                    <%out.println(s10);%>
                    <p>&nbsp; </p>
                  </div></td>  
              ...
              <%
						...
						%>
              <td  width="80" valign="baseline" height="0" style="color:#000000;"align="center"><div align="center" class="style4 style5 style27">
                  <p>&nbsp;</p>
              ...
              <%
						...
						{
						%>
              <td width="64" height="0"  valign="baseline"><p class="style5 style8 style4">&nbsp;</p>
                  <div align="center" class="style5 style8 style4"><strong>
                  <%out.println(s12);%>
                  </strong></div></td>
              <%
						}
